        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('kategori/buku') ?>">
                    ...
                    <span>Buku dan Alat tulis</span></a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <div class="navbar">
                            <ul class="nav navbar-nav navbar-right">
                                <li>
                                    <?php $keranjang = '<i class="fas fa-shopping-bag mr-2"></i>' . $this->cart->total_items() . 'items' ?>
                            ...
                            <ul class=" na navbar-nav navbar-right">
                                <?php if ($this->session->userdata('username')) { ?>
                                    <li>
                                        <div><i class="fas fa-user-circle mr-2"></i><?php echo $this->session->userdata('username') ?></div>
                                    </li>
